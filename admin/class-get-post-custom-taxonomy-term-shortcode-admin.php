...
//wp_enqueue_style( $this->plugin_name,'wp-jquery-ui-dialog' );
        ...
        if (!empty($_GET['page']) && $_GET['page'] != '' && $_GET['page'] == 'get-post-custom-taxonomy-term-shortcode') {
    ...
    public function get_post_per_page() {
        ...
        $post_per_page = get_ob_post_per_page($_POST['post_per_page']);
        echo '$post_per_page';
    ...
    public function get_textonomy() {
        ...
        if (!empty($taxonomy_objects)) {
            echo '<tr valign="top">
					<th scope="row">
						<label for="default_role">Select Taxonomy</label>
					</th>
					<td>
    ...
    public function welcome_screen_content_advanced_post_listing_shortcode() {
        ...
        <div class="wrap about-wrap">
            ...
            <div class="return-to-dashboard">
                <a href="<?php echo home_url('/wp-admin/admin.php?page=get-post-custom-taxonomy-term-shortcode'); ?>"><?php _e('Go to Advanced Post Listing Shortcode Settings', 'get-post-custom-taxonomy-term-shortcode'); ?></a>
            </div>
        </div>	
...
// function for welcome page about us tag content 
    ...
    public function gtsortcode_register_meta_boxes() {
